  ...
  return (
    <>
      ...
      <div className="w-full  py-20 flex items-center  justify-center flex-col">
        <h1 className="text-xl mt-4 uppercase tracking-widest border-b-2 border-b-[#FECF13] py-2 font-semibold mb-8 md:text-2xl lg:text-4xl">
          Enter Job Details
        </h1>
        <form
        ...
        >
          <div className="w-full mb-4  flex flex-col items-start justify-center">
            ...
            <input
              ...
              type="text"
              id="title"
              className="w-full py-2 px-3 mb-2 border border-[#FECF13] rounded"
          ...
          <button
            type="submit"
            className="w-full py-2 rounded bg-[#FECF13] text-black font-semibold tracking-widest"
          >
            Submit
          </button>
        </form>
