    ...
    <>
      {isLoading ? (
        <div className="bg-gray w-full h-screen flex items-center flex-col justify-center">
          <InfinitySpin width="200" color="#F5C712" />
        ...
        <>
          ...
          <div className="w-full  py-20 flex items-center md:px-8 px-2  justify-center flex-col  ">
            <div className="w-full h-40 bg-black text-[#FECF13] font-bold flex items-center justify-center flex-col">
              ...
              <div className="flex w-full px-8 md:px-20 items-start md:flex-row flex-col md:justify-between justify-center">
                ...
                <div className="md:px-4 mb-1 px-2 md:mx-2 flex flex-col items-start justify-center">
                  <div className="flex items-center justify-center mb-1">
                    <FaUserAstronaut className="text-xs font-semibold text-[#FECF13]" />
                  ...
                  <div className="flex items-center justify-center mb-1">
                    <MdEmail className="text-xs font-semibold text-[#FECF13]" />
                ...
                <div className="md:px-4 mb-1 px-2 md:mx-2 flex flex-col items-start justify-center">
                  <div className="flex items-center justify-center mb-1">
                    <GoLocation className="text-xs font-semibold text-[#FECF13]" />
                    <p className="font-semibold text-base mx-1">Location </p>
                    <p className=" text-sm text-gray-800 mx-1">Rawalipindi</p>
                  </div>
                  <div className="flex items-center justify-center mb-1">
                    <MdCategory className="text-xs font-semibold text-[#FECF13]" />
                ...
                <div className="md:px-4 mb-1 px-2 md:mx-2 flex flex-col items-start justify-center">
                  <div className="flex items-center justify-center mb-1">
                    <BsBriefcaseFill className="text-xs font-semibold text-[#FECF13]" />
                  ...
                  <div className="flex items-center justify-center mb-1">
                    <AiOutlineDollarCircle className="text-xs font-semibold text-[#FECF13]" />
                  ...
                  {JobDetails?.user?.email === user?.email ? (
                    ...
                    <div className="flex items-center justify-center  ">
                      <BsFillBookmarkCheckFill
                        ...
                        className="text-[#FECF13] text-4xl cursor-pointer  mx-2"
                      />
                      <button
                        onClick={handleApply}
                        className="md:px-6 md:py-3 px-3 py-2 mt-2 md:mt-0 bg-[#F5C712] rounded text-base tracking-widest uppercase transition-all duration-700 hover:bg-yellow-400 text-black  "
                      >
                        Apply Position
                      </button>
                    </div>
            ...
            <div className="w-full md:px-4 py-2 flex items-center md:items-start md:flex-row flex-col justify-start md:justify-center">
              <div className="md:w-8/12 w-full md:px-4 py-8 flex flex-col items-center content-start justify-center ">
                <h1 className="text-center lg:text-2xl font-semibold text-xl mb-4 uppercase border-b-2 border-[#FECF13] py-2">
                  Job Description
                </h1>
              ...
              <div className="md:w-4/12 w-full py-8 px-4 md:px-10">
                ...
                <div className="flex items-center justify-start mb-3">
                  <RiUserSearchFill className="text-base font-semibold text-[#FECF13]" />
                ...
                <div className="flex items-center justify-start mb-3">
                  <BsFillCalendar2DateFill className="text-base font-semibold text-[#FECF13]" />
                ...
                <div className="flex items-center justify-start mb-3">
                  <HiOutlineStar className="text-base font-semibold text-[#FECF13]" />
                  <p className="font-semibold text-base mx-1">
                    Experience Required
                  </p>
                  <p className=" text-sm text-gray-800 mx-1">
                      ...
                      >
                        ...
                        <div className="flex flex-col px-1 md:px-4 py-6 items-start justify-center">
                          <div className="flex px-1 md:px-4 items-center justify-start mb-2">
                            <BsBriefcaseFill className="text-base font-semibold text-[#FECF13]" />
                          ...
                          <div className="flex px-1 md:px-4 items-center justify-center mb-2">
                            <AiOutlineDollarCircle className="text-base font-semibold text-[#FECF13]" />
                            <p className="font-semibold text-xs md:text-base mx-1">
                              Salary{" "}
                            </p>
                            <p className=" text-sm text-gray-800 mx-1">
                        ...
                        <button
                          ...
                          className="my-2 py-2 px-4  border border-[#FECF13] uppercase  rounded flex items-center justify-center transition-all duration-700 hover:bg-[#FECF13] hover:text-black text-[#FECF13] font-semibold"
                        >
                          View Detail
