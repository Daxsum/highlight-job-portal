    ...
    >
      ...
      <div className="mb-4 flex   items-start justify-center py-2 flex-col">
        <div className="flex  px-2 py-2 items-center justify-center ">
          <BsDot className="text-4xl font-extrabold text-[#FECF13]" />
      ...
      <div className="mb-4 flex flex-col md:flex-wrap md:flex-row w-full justify-between  items-center ">
        <div className="mb-4 flex  items-start justify-center py-2 flex-col">
          <div className="flex px-6 rounded-2xl py-1 items-center justify-center bg-yellow-200 text-black  ">
            <p>{job?.title} </p>
          </div>
        </div>
        {posted ? (
          <button
            ...
            className="my-2 py-2 px-4  border border-[#FECF13]   rounded flex items-center justify-center transition-all duration-700 hover:bg-[#FECF13] hover:text-black text-[#FECF13] font-semibold"
          >
