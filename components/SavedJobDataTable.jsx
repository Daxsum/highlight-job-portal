    ...
    },
    {
      ...
      cell: (row) => (
        <button
          ...
          className="md:px-2 md:py-2 px-1 py-1 text-xl text-red-600 hover:text-black my-2 hover:bg-red-600 border border-red-600   rounded transition-all duration-700  "
        >
          <AiFillDelete />
        </button>
      ),
    },
    {
      ...
      cell: (row) => (
        <button
          ...
          className="md:px-2 md:py-2 px-1 py-1 text-xs text-[#FECF13] hover:text-black my-2 hover:bg-[#FECF13] border border-[#FECF13]   rounded transition-all duration-700  "
        >
          view Detail
        </button>
      ),
  ...
  return (
    <>
      <DataTable
        ...
        subHeaderComponent={
          <input
            className="w-60  py-2 px-2  outline-none  border-b-2 border-[#FECF13]"
            type={"search"}
            value={search}
