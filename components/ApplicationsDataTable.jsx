    ...
    },
    {
      ...
      selector: (row) => (
        <button
          ...
          className=" w-20 py-2 text-xs text-[#FECF13] hover:text-black my-2 hover:bg-[#FECF13] border border-[#FECF13] rounded transition-all duration-700"
        >
          Download CV
        </button>
      ),
      ...
      cell: (row) => (
        <div className="flex items-center justify-start w-72 h-20">
          <button
            ...
            className=" w-20 py-2 mx-2 text-xs text-[#FECF13] hover:text-white my-2 hover:bg-[#FECF13] border border-[#FECF13] rounded transition-all duration-700"
          >
            Details
          </button>
          <button
