...
export default function NavBar() {
  ...
  return (
    <>
      <div
        className={`w-full ${
          scrolled ? "bg-[#FECF13]/70" : "bg-[#FECF13]"
        } px-6 h-20 bg-[#FECF13] text-black flex items-center justify-between fixed top-0 left-0 z-50`}
      >
        <div className="px-2 h-full flex items-center justify-center">
          <p className="uppercase font-semibold tracking-widest text-lg animate-rotate-x animate-once animate-ease-linear">
            <span>
              <img src="/HighlightLogo.svg" className="w-24"></img>
            </span>{" "}
            JOB-PORTAL
          </p>
        </div>
        <div className="px-2 h-full hidden items-center justify-center lg:flex">
          <Link
            href={"/"}
            className=" px-3 mx-4 text-base font-medium transition-all duration-700 hover:animate-jump hover:animate-once animate-ease-linear uppercase"
          >
            Home
          </Link>
          <Link
        ...
        <div className="px-2 h-full hidden items-center justify-center lg:flex ">
          {user !== null ? (
            ...
            <>
              ...
              <Link
                href={"/auth/register"}
                className="px-4 py-2 border border-white rounded uppercase tracking-widest mx-4   text-[#FECF13] bg-white transition-all duration-700 hover:bg-transparent font-semibold text-base hover:text-black"
              >
                REGISTER
              </Link>
            </>
        ...
        {isOpen && (
          <div
            ref={ref}
            className="flex w-full py-2 animate-fade-in-down  bg-[#FECF13] transition-all fade duration-1000 absolute top-20 left-0  items-center justify-center flex-col "
          >
